      ...
      _vm.attrs.showCustomTools
        ? _c(
            ...
            [
              _c(
                "el-dropdown",
                { on: { command: _vm.$quote_item_click } },
                [
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "el-dropdown-item",
                        { attrs: { command: "primary" } },
                        [_vm._v("primary")]
                      ),
                      _vm._v(" "),
                      _c(
                        "el-dropdown-item",
                        { attrs: { command: "success" } },
                        [_vm._v("success")]
                      ),
                      _vm._v(" "),
                      _c("el-dropdown-item", { attrs: { command: "info" } }, [
                        _vm._v("info"),
                      ]),
                      _vm._v(" "),
                      _c("el-dropdown-item", { attrs: { command: "danger" } }, [
                        _vm._v("danger"),
                      ]),
                      _vm._v(" "),
                      _c(
                        "el-dropdown-item",
                        { attrs: { command: "warning" } },
                        [_vm._v("warning")]
                      ),
                    ],
                    1
