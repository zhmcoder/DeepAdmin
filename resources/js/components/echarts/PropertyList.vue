          ...
          <el-table :data="tableData" style="width: 100%" :show-header="attrs.data.is_title==1">
                <el-table-column v-for="(col, i) in attr_names" :key="i" :prop="col.prop">
                  ...
                  <template slot-scope="scope">
                    <el-input-number v-if="col.type=='number'" :min="0" size="mini" :precision="col.precision" :placeholder="0" v-model="scope.row[col.prop]" @input="changeInput">0</el-input-number>
