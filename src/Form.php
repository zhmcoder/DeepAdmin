...
use Andruby\DeepAdmin\Form\FormActions;
use Andruby\DeepAdmin\Form\FormAttrs;
use Andruby\DeepAdmin\Form\FormItem;
use Andruby\DeepAdmin\Form\HasHooks;
use Andruby\DeepAdmin\Form\HasRef;
use Andruby\DeepAdmin\Form\TraitFormAttrs;
...
class Form extends Component
{
    ...
    public function __construct($model = null)
    {
        ...
        $this->model = $model;
        //deep admin start
        $this->dataUrl = admin_api_url(request()->getUri());
        //deep admin end
    ...
    public function store()
    {
        ...
        return Admin::responseMessage(trans('deep-admin::admin.save_succeeded'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return \Admin::responseMessage(trans('deep-admin::admin.delete_succeeded'));
        } catch (\Exception $exception) {
            return \Admin::responseError($exception->getMessage() ?: trans('deep-admin::admin.delete_failed'));
        }
    }
    ...
    public function update($id, $data = null)
    {
        ...
        return Admin::responseMessage(trans('deep-admin::admin.update_succeeded'));
    }
