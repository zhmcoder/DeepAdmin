...
use Andruby\DeepAdmin\Auth\Permission as Checker;
...
class Permission
{
    ...
    public function handle(Request $request, \Closure $next, ...$args)
    {
        ...
        if (!Admin::user()->allPermissions()->first(function (\Andruby\DeepAdmin\Auth\Database\Permission $permission) use ($request) {
