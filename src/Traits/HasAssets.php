...
trait HasAssets
{
    ...
    public static function js($js = null, $minify = true)
    {
        ...
        return view('deep-admin::partials.js', compact('js'));
    }
    ...
    public static function headerJs($js = null)
    {
        ...
        return view('deep-admin::partials.js', ['js' => array_unique(static::$headerJs)]);
    }
    ...
    public static function script($script = '', $deferred = false)
    {
        ...
        return view('deep-admin::partials.script', compact('script'));
    }
    ...
    public static function style($style = '')
    {
        ...
        return view('deep-admin::partials.style', ['style' => array_unique(self::$style)]);
    }
    ...
    public static function html($html = '')
    {
        ...
        return view('deep-admin::partials.html', ['html' => array_unique(self::$html)]);
    }
